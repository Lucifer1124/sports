...
P{
    ...
    <body style="
       ...
       <div style="text-align: center; color: darkgrey;  text-shadow: 2px 2px 2px black;"><h2>FOOTBALL</h2></div>
      <div class="Latest">
                  <%
                  ItemDaoimpl dao=new ItemDaoimpl(DBConnect.getConn());
                  List<Items> list=dao.getAllFootball();
                  for(Items i:list){%>
                  ...
                  <div class="container">
                      ...
                      <div class="roww">                        
                          ...
                          <div><a href="" class="btn btn-success btn-sm abc abcd imgborder">Add to cart</a></div>
                      </div>      
                  </div>  
